...
export default function TermsPage() {
  return (
    <MarketingPage
      ...
      description="StartupFiles’ plans are unusually explicit about what the app should and should not imply, especially around legal advice, operator identity, and business-formation status."
      sections={[
        {
          title: "No professional advice",
          body: "StartupFiles prepares documents, organizes answers, and guides users through official resources, but it is not a law firm, CPA firm, or tax advisor."
        },
        {
